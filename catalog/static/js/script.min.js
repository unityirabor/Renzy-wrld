...
setTimeout(() => {
       ...
       if (alert) {
           alert.style.transition = "opacity 1s ease";  // Smooth fade-out over 1 second
           alert.style.opacity = "0";  
   
           setTimeout(() => {
               alert.style.display = "none";  // Completely hide after fade-out
           }, 1000);  // Matches the transition time (1s)
       }
}, 4000);  // Start fade-out after 5 seconds

// setTimeout(() => {
//        let alert = document.getElementById("message").fadeOut('slow');
//        if (alert) {
//            alert.style.display = "none";
//        }
// }, 4000);  // Hides the message after 5 seconds
